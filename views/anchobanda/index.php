<div class="container container-fluid">
  ...
  <div class="card mt-3 shadow-lg p-3 mb-5 bg-body rounded">
      <ol class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item active" id="indicador" aria-current="page">Ancho de Banda</li>
      </ol>
  </div>
  <!-- End Breadcrumb -->
  ...
  <div class="card">
    <div class="card-header bg-info">
      <h5 class="float-start text-light">Ancho de Banda</h5>
    </div>
    <div class="card-body">
      <input id="actioneliminar" type="hidden" value="anchobanda/delete/">
      <input id="actionview" type="hidden" value="anchobanda/view/">
      ...
      <tbody>
        <tr>
          ...
          <td id="1">Contratos vigentes del servicio de internet a nombre de la institución o autoridad de esta, que indique los kilobits por segundo contratados, y las condiciones y el lugar de prestación del servicio (captados a través del aplicativo SIIES)</td>
          ...
          <div class="col" role="group" aria-label="Basic example">
            ...
            <?php                                     
              $evidencia = 'Contratos vigentes del servicio de internet a nombre de la institución o autoridad de esta, que indique los kilobits por segundo contratados, y las condiciones y el lugar de prestación del servicio (captados a través del aplicativo SIIES)';
        ...
        <tr>
          ...
          <td id="2">Facturas de pago del servicio de internet del periodo de evaluación (captadas a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Facturas de pago del servicio de internet del periodo de evaluación (captadas a través del aplicativo SIIES)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td id="3">Lista certificada de los empleados administrativos que utilizan un computador conectado a internet para su trabajo en la institución (captada a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Lista certificada de los empleados administrativos que utilizan un computador conectado a internet para su trabajo en la institución (captada a través del aplicativo SIIES)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td id="4">Lista certificada de los estudiantes por modalidad de estudio, carrera, semestre y jornada(matutina, vespertina y nocturna), matriculados en cada período académico del periodo de evaluación (captada a través del aplicativo SIIES)</td>
    ...
    <div class="card-footer text-center bg-info">      
      <?php if($_SESSION['tipousuario_sisgec'] == 'Evaluador'){ ?>    
        ...
        <input type="hidden" id="rutainsert" value="anchobanda/calificacion/">
        <input type="hidden" id="rutaview" value="anchobanda/viewcalificacion/">
...
<div class="modal fade" id="exampleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="form" action="anchobanda/insert/">
