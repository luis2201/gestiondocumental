.<div class="container container-fluid">
  ...
  <div class="card mt-3 shadow-lg p-3 mb-5 bg-body rounded">
      <ol class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item active" id="indicador" aria-current="page">Educación Ambiental y Desarrollo Sostenible</li>
      </ol>
  </div>
  <!-- End Breadcrumb -->
  ...
  <div class="card">
    <div class="card-header bg-info">
      <h5 class="float-start text-light">Educación Ambiental y Desarrollo Sostenible</h5>
    </div>
    <div class="card-body">
      <input id="actioneliminar" type="hidden" value="educacionambiental/delete/">
      <input id="actionview" type="hidden" value="educacionambiental/view/">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center" style="width:500px">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Evidencias de las acciones de promoción y difusión del cuidado ambiental implementadas por la institución (materiales de campañas creadas o en las que participa la institución, convenios suscritos con otras instituciones para la promoción del cuidado ambiental, PEA de los cursos de formación continua y registros de participantes, entrevistas a profesores y estudiantes, etc.) (captadas a través del aplicativo SIIES y visita in situ)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td class="text-center" style="width:500px">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Evidencias de las acciones de buenas prácticas ambientales implementadas por la institución (proyectos de buenas prácticas ambientales y sus respectivos informes de cumplimiento, certificaciones ambientales obtenidas, entrevistas a profesores y estudiantes, etc.) (captadas a través del aplicativo SIIES y visita in situ)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td id="4">Programas y/o proyectos de I+D y programas y/o proyectos de vinculación centrados en problemas ambientales identificados en el área de influencia de la institución, o que incluyan el enfoque ambiental sobre la base de lo indicado en la Descripción (captados a través del aplicativo SIIES)</td>
          ...
          <td class="text-center" style="width:500px">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Programas y/o proyectos de I+D y programas y/o proyectos de vinculación centrados en problemas ambientales identificados en el área de influencia de la institución, o que incluyan el enfoque ambiental sobre la base de lo indicado en la Descripción (captados a través del aplicativo SIIES)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
    ...
    <div class="card-footer text-center bg-info">      
      <?php if($_SESSION['tipousuario_sisgec'] == 'Evaluador'){ ?>  
        ...
        <input type="hidden" id="rutainsert" value="educacionambiental/calificacion/">
        <input type="hidden" id="rutaview" value="educacionambiental/viewcalificacion/">
...
<div class="modal fade" id="exampleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="form" action="educacionambiental/insert/">
