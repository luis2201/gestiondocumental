.<div class="container container-fluid">
  ...
  <div class="card mt-3 shadow-lg p-3 mb-5 bg-body rounded">
      <ol class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item active" id="indicador" aria-current="page">Formación Complementaria</li>
      </ol>
  </div>
  <!-- End Breadcrumb -->
  ...
  <div class="card">
    <div class="card-header bg-info">
      <h5 class="float-start text-light">Formación Complementaria</h5>
    </div>
    <div class="card-body">
      <input id="actioneliminar" type="hidden" value="formacioncomplementaria/delete/">
      <input id="actionview" type="hidden" value="formacioncomplementaria/view/">
      ...
      <tbody>
        <tr>
          ...
          <td id="1">Documento de la planificación de la oferta de formación complementaria (captado a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Documento de la planificación de la oferta de formación complementaria (captado a través del aplicativo SIIES)';
        ...
        <tr>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Evidencias de la ejecución de las actividades de formación complementaria (informes, certificados, material audiovisual explícito, entrevistas a estudiantes que participaron en las actividades de formación complementaria, etc.) Los registros en audio y video deben cumplir con lo establecido en el Art. 178 del COIP (captadas a través del aplicativo SIIES y visita in situ)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td id="3">Evidencias de la promoción de las actividades y eventos de formación complementaria, así como de la difusión de sus resultados a la comunidad educativa (correos electrónicos, afiches, material audiovisual explícito, informes, etc.) Los registros en audio y video deben cumplir con lo establecido en el Art. 178 del COIP (captadas a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Evidencias de la promoción de las actividades y eventos de formación complementaria, así como de la difusión de sus resultados a la comunidad educativa (correos electrónicos, afiches, material audiovisual explícito, informes, etc.) Los registros en audio y video deben cumplir con lo establecido en el Art. 178 del COIP (captadas a través del aplicativo SIIES)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td id="4">Evidencias del seguimiento, control y evaluación de las actividades y eventos de formación complementaria (informes, actas de reuniones, etc.) (captadas a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Evidencias del seguimiento, control y evaluación de las actividades y eventos de formación complementaria (informes, actas de reuniones, etc.) (captadas a través del aplicativo SIIES)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
    ...
    <div class="card-footer text-center bg-info">      
      <?php if($_SESSION['tipousuario_sisgec'] == 'Evaluador'){ ?>         
        ...
        <input type="hidden" id="rutainsert" value="formacioncomplementaria/calificacion/">
        <input type="hidden" id="rutaview" value="formacioncomplementaria/viewcalificacion/">
...
<div class="modal fade" id="exampleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="form" action="formacioncomplementaria/insert/">
