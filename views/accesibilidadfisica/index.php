<div class="container container-fluid">
  ...
  <div class="card mt-3 shadow-lg p-3 mb-5 bg-body rounded">
      <ol class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item active" id="indicador" aria-current="page">Accesibilidad Física y Esparcimiento</li>
      </ol>
  </div>
  <!-- End Breadcrumb -->
  ...
  <div class="card">
    <div class="card-header bg-info">
      <h5 class="float-start text-light">Accesibilidad Física y Esparcimiento</h5>
    </div>
    <div class="card-body">
      <input id="actioneliminar" type="hidden" value="accesibilidadfisica/delete/">
      <input id="actionview" type="hidden" value="accesibilidadfisica/view/"> 
      ...
      <tbody>
        <tr>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Verificación de las condiciones de accesibilidad física para las personas con discapacidad, específicamente el cumplimiento de los requisitos indicados en el primer elemento fundamental. En las construcciones nuevas deberá verificarse el cumplimiento de la normativa referida en la Descripción (visita in situ)';
        ...
        <tr>
          ...
          <td id="2">Entrevistas a los miembros de la comunidad educativa (visita in situ)</td>          
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              <?php if($_SESSION['tipousuario_sisgec']=='Infraestructura') { ?>
              ...
              <?php                                     
                $evidencia = 'Entrevistas a los miembros de la comunidad educativa (visita in situ)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td id="3">Verificación del cumplimiento de las exigencias planteadas en los elementos fundamentales 2, 3 y 4 (visita in situ)</td>          
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              <?php if($_SESSION['tipousuario_sisgec']=='Infraestructura') { ?>
              ...
              <?php                                     
                $evidencia = 'Verificación del cumplimiento de las exigencias planteadas en los elementos fundamentales 2, 3 y 4 (visita in situ)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
    ...
    <div class="card-footer text-center bg-info">      
      <?php if($_SESSION['tipousuario_sisgec'] == 'Evaluador'){ ?>       
        ...
        <input type="hidden" id="rutainsert" value="accesibilidadfisica/calificacion/">
        <input type="hidden" id="rutaview" value="accesibilidadfisica/viewcalificacion/">
...
<div class="modal fade" id="exampleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="form" action="accesibilidadfisica/insert/">
