.<div class="container container-fluid">
  ...
  <div class="card mt-3 shadow-lg p-3 mb-5 bg-body rounded">
      <ol class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item active" id="indicador" aria-current="page">Remuneración Promedio Mensual TC</li>
      </ol>
  </div>
  <!-- End Breadcrumb -->
  ...
  <div class="card">
    <div class="card-header bg-info">
      <h5 class="float-start text-light">Remuneración Promedio Mensual TC</h5>
    </div>
    <div class="card-body">
      <input id="actioneliminar" type="hidden" value="remuneracionpromediomensual/delete/">
      <input id="actionview" type="hidden" value="remuneracionpromediomensual/view/">
      ...
      <tbody>
        <tr>
          ...
          <td id="1">Contratos o nombramientos del personal académico que perteneció a la institución durante el periodo de evaluación (captados a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Contratos o nombramientos del personal académico que perteneció a la institución durante el periodo de evaluación (captados a través del aplicativo SIIES)';
        ...
        <tr>
          ...
          <td id="2">Mecanizados de aportes al IESS de los profesores (captados a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Mecanizados de aportes al IESS de los profesores (captados a través del aplicativo SIIES)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td id="3">Facturas, a nombre del interesado, de los profesores TC y MT que trabajan sin relación de dependencia. Las facturas deben indicar los meses de trabajo a los que corresponde el monto pagado (captadas a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Facturas, a nombre del interesado, de los profesores TC y MT que trabajan sin relación de dependencia. Las facturas deben indicar los meses de trabajo a los que corresponde el monto pagado (captadas a través del aplicativo SIIES)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
    ...
    <div class="card-footer text-center bg-info">      
      <?php if($_SESSION['tipousuario_sisgec'] == 'Evaluador'){ ?>    
        ...
        <input type="hidden" id="rutainsert" value="remuneracionpromediomensual/calificacion/">
        <input type="hidden" id="rutaview" value="remuneracionpromediomensual/viewcalificacion/">
...
<div class="modal fade" id="exampleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="form" action="remuneracionpromediomensual/insert/">
