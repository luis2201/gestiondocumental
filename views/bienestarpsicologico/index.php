<div class="container container-fluid">
  ...
  <div class="card mt-3 shadow-lg p-3 mb-5 bg-body rounded">
      <ol class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item active" id="indicador" aria-current="page">Bienestar Psicológico</li>
      </ol>
  </div>
  <!-- End Breadcrumb -->
  ...
  <div class="card">
    <div class="card-header bg-info">
      <h5 class="float-start text-light">Bienestar Psicológico</h5>
    </div>
    <div class="card-body">
      <input id="actioneliminar" type="hidden" value="bienestarpsicologico/delete/">
      <input id="actionview" type="hidden" value="bienestarpsicologico/view/">
      ...
      <tbody>
        <tr>
          ...
          <td id="1">Captación de información sobre apreciaciones de los integrantes de la comunidad educativa en relación con los elementos fundamentales 2 y 3, a través de entrevistas, grupos focales, etc. (visita in situ)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Captación de información sobre apreciaciones de los integrantes de la comunidad educativa en relación con los elementos fundamentales 2 y 3, a través de entrevistas, grupos focales, etc. (visita in situ)';
        ...
        <tr>
          ...
          <td id="2">Documentos de los proyectos de intervención basados en la psicología positiva con los componentes y requisitos indicados en la Descripción (captados a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Documentos de los proyectos de intervención basados en la psicología positiva con los componentes y requisitos indicados en la Descripción (captados a través del aplicativo SIIES)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Evidencias de la ejecución de los programas de intervención positiva y del cumplimiento de sus objetivos (entrevistas a participantes, material audiovisual explícito, registros de asistencia a actividades, etc.) Los registros en audio y video deben cumplir con lo establecido en el Art. 178 del COIP (captadas a través del aplicativo SIIES y visita in situ)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td id="4">Documentos con la propuesta pedagógica de la institución (captados a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Documentos con la propuesta pedagógica de la institución (captados a través del aplicativo SIIES)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
    ...
    <div class="card-footer text-center bg-info">      
      <?php if($_SESSION['tipousuario_sisgec'] == 'Evaluador'){ ?> 
        ...
        <input type="hidden" id="rutainsert" value="bienestarpsicologico/calificacion/">
        <input type="hidden" id="rutaview" value="bienestarpsicologico/viewcalificacion/">
...
<div class="modal fade" id="exampleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="form" action="bienestarpsicologico/insert/">
