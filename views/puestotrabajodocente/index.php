<div class="container container-fluid">
  ...
  <div class="card mt-3 shadow-lg p-3 mb-5 bg-body rounded">
      <ol class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item active" id="indicador" aria-current="page">Puestos de Trabajo de los Profesores</li>
      </ol>
  </div>
  <!-- End Breadcrumb -->
  ...
  <div class="card">
    <div class="card-header bg-info">
      <h5 class="float-start text-light">Puestos de Trabajo de los Profesores</h5>
    </div>
    <div class="card-body">
      <input id="actioneliminar" type="hidden" value="puestotrabajodocente/delete/">
      <input id="actionview" type="hidden" value="puestotrabajodocente/view/">
      ...
      <tbody>
        <tr>
          ...
          <td id="1">Verificación del número y condiciones de los puestos de trabajo para profesores, según lo indicado en la Descripción (visita in situ)</td>
          
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              <?php if($_SESSION['tipousuario_sisgec']=='Infraestructura'){
                $evidencia = 'Verificación del número y condiciones de los puestos de trabajo para profesores, según lo indicado en la Descripción (visita in situ)';
        ...
        <tr>
          ...
          <td id="2">Lista certificada de los profesores que trabajan a tiempo completo y a medio tiempo cuando se desarrolla la visita in situ (visita in situ)</td>
          
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              <?php if($_SESSION['tipousuario_sisgec']=='Infraestructura') { 
                $evidencia = 'Lista certificada de los profesores que trabajan a tiempo completo y a medio tiempo cuando se desarrolla la visita in situ (visita in situ)';
                $evidencias = Model::evidencias($evidencia);                
                  ?>
    ...
    <div class="card-footer text-center bg-info">      
      <?php if($_SESSION['tipousuario_sisgec'] == 'Evaluador'){ ?>
        ...
        <input type="hidden" id="rutainsert" value="puestotrabajodocente/calificacion/">
        <input type="hidden" id="rutaview" value="puestotrabajodocente/viewcalificacion/">
...
<div class="modal fade" id="exampleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="form" action="puestotrabajodocente/insert/">
