.<div class="container container-fluid">
  ...
  <div class="card mt-3 shadow-lg p-3 mb-5 bg-body rounded">
      <ol class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item active" id="indicador" aria-current="page">Acompañamiento Pedagógico a Estudiantes</li>
      </ol>
  </div>
  <!-- End Breadcrumb -->
  ...
  <div class="card">
    <div class="card-header bg-info">
      <h5 class="float-start text-light">Acompañamiento Pedagógico a Estudiantes</h5>
    </div>
    <div class="card-body">
      <input id="actioneliminar" type="hidden" value="acompanamientoestudiantes/delete/">
      <input id="actionview" type="hidden" value="acompanamientoestudiantes/view/">
      ...
      <tbody>        
        <tr>
          ...
          <td id="1">Instrumentos que se utilizan en el proceso de admisión para obtener información de los aspirantes (formatos de pruebas, encuestas, formularios, exámenes de conocimiento, etc.) (captados a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Instrumentos que se utilizan en el proceso de admisión para obtener información de los aspirantes (formatos de pruebas, encuestas, formularios, exámenes de conocimiento, etc.) (captados a través del aplicativo SIIES)';
        ...
        <tr>
          ...
          <td id="2">Instrumentos aplicados con la información captada de cada estudiante (informes sobre el perfil de los estudiantes, informes socioeconómicos, etc.) (visita in situ)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Instrumentos aplicados con la información captada de cada estudiante (informes sobre el perfil de los estudiantes, informes socioeconómicos, etc.) (visita in situ)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td id="3">Evidencias de la utilización de la información obtenida en el proceso de admisión para el diseño del trabajo didáctico y pedagógico en general (planes de acompañamiento pedagógico, informes de adaptaciones curriculares sugeridas, etc.) (captadas a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Evidencias de la utilización de la información obtenida en el proceso de admisión para el diseño del trabajo didáctico y pedagógico en general (planes de acompañamiento pedagógico, informes de adaptaciones curriculares sugeridas, etc.) (captadas a través del aplicativo SIIES)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td id="4">Evidencias de las actividades realizadas como parte del proceso de acompañamiento y sus resultados (informes, actas de reuniones, actas de tutorías, entrevistas a estudiantes y profesores, etc.) (captadas a través del aplicativo SIIES y visita in situ)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Evidencias de las actividades realizadas como parte del proceso de acompañamiento y sus resultados (informes, actas de reuniones, actas de tutorías, entrevistas a estudiantes y profesores, etc.) (captadas a través del aplicativo SIIES y visita in situ)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td id="6">Normativa interna, aprobada y vigente, de acompañamiento a estudiantes y de aplicación de estímulos positivos (captada a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Normativa interna, aprobada y vigente, de acompañamiento a estudiantes y de aplicación de estímulos positivos (captada a través del aplicativo SIIES)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Evidencias de la aplicación del sistema de estímulos (actas del Órgano Colegiado Superior, material audiovisual explícito sobre los actos de entrega de los estímulos, entrevistas a los miembros de la comunidad educativa estimulados, etc.) Los registros en audio y video deben cumplir con lo establecido en el Art. 178 del COIP (captadas a través del aplicativo SIIES y visita in situ)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
    ...
    <div class="card-footer text-center bg-info">      
      <?php if($_SESSION['tipousuario_sisgec'] == 'Evaluador'){ ?>  
        ...
        <input type="hidden" id="rutainsert" value="acompanamientoestudiantes/calificacion/">
        <input type="hidden" id="rutaview" value="acompanamientoestudiantes/viewcalificacion/">
...
<div class="modal fade" id="exampleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="form" action="acompanamientoestudiantes/insert/">
