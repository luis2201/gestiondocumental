<div class="container container-fluid">
  ...
  <div class="card mt-3 shadow-lg p-3 mb-5 bg-body rounded">
      <ol class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item"><a id="subcriterio" href="#">Presencia en la Comunidad</a></li>
        <li class="breadcrumb-item active" id="indicador" aria-current="page">Presencia de la Institución en la Comunidad</li>
      </ol>
  </div>
  <!-- End Breadcrumb -->
  ...
  <div class="card">
    <div class="card-header bg-info">
      <h5 class="float-start text-light">Presencia de la Institución en la Comunidad</h5>
    </div>
    <div class="card-body">
      <input id="actioneliminar" type="hidden" value="presenciacomunidad/delete/">
      <input id="actionview" type="hidden" value="presenciacomunidad/view/">
      ...
      <tbody>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              <?php if($_SESSION['tipousuario_sisgec']=='Vinculación con la Sociedad') { ?>
                ...
                <?php                                     
                  $evidencia = 'Evidencias de las actividades sociales y culturales en las que ha participado, y de las que ha organizado la institución (material gráfico y audiovisual explícito, informes de resultados, cartas de invitación, etc.) Los registros en audio y video deben cumplir con lo establecido en el Art.178 del COIP (captadas a través del aplicativo SIIES y visita in situ)';
        ...
        <tr>
          ...
          <td id="2">Evidencias del acceso de la comunidad a espacios institucionales (registros de usuarios, solicitudes de uso, etc.) (captadas a través del aplicativo SIIES y visita in situ)</td>
          <td class="text-center"></td>
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              <?php if($_SESSION['tipousuario_sisgec']=='Vinculación con la Sociedad') { ?>
                ...
                <?php                                     
                  $evidencia = 'Evidencias del acceso de la comunidad a espacios institucionales (registros de usuarios, solicitudes de uso, etc.) (captadas a través del aplicativo SIIES y visita in situ)';
                  $evidencias = Model::evidencias($evidencia);
                  foreach($evidencias as $row):   
                ?>                           
                  <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              <?php if($_SESSION['tipousuario_sisgec']=='Vinculación con la Sociedad') { ?>
                ...
                <?php                                     
                  $evidencia = 'Evidencias de las acciones para contribuir al desarrollo de intereses profesionales afines a las carreras del instituto en los estudiantes de bachillerato y en jóvenes egresados de este nivel de enseñanza que se interesan por conocer opciones para continuar sus estudios que ha ejecutado la institución (material audiovisual explícito, informes de resultados, documentos de planificación de actividades, etc.) Los registros en audio y video deben cumplir con lo establecido en el Art. 178 del COIP (captadas a través del aplicativo SIIES y visita in situ)';
                  $evidencias = Model::evidencias($evidencia);
                  foreach($evidencias as $row):   
                ?>                           
                  <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
    ...
    <div class="card-footer text-center bg-info">      
      <?php if($_SESSION['tipousuario_sisgec'] == 'Evaluador'){ ?> 
        ...
        <input type="hidden" id="rutainsert" value="presenciacomunidad/calificacion/">
        <input type="hidden" id="rutaview" value="presenciacomunidad/viewcalificacion/">
...
<div class="modal fade" id="exampleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="form" action="presenciacomunidad/insert/">
