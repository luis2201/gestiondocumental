.<div class="container container-fluid">
  ...
  <div class="card mt-3 shadow-lg p-3 mb-5 bg-body rounded">
      <ol class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item active" id="indicador" aria-current="page">Aulas</li>
      </ol>
  </div>
  <!-- End Breadcrumb -->
  ...
  <div class="card">
    <div class="card-header bg-info">
      <h5 class="float-start text-light">Aulas</h5>
    </div>
    <div class="card-body">
      <input id="actioneliminar" type="hidden" value="aulas/delete/">
      <input id="actionview" type="hidden" value="aulas/view/">
      ...
      <tbody>
        <tr>
          ...
          <td id="1">Verificación de las condiciones de las aulas, según lo indicado en la Descripción (visita in situ)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Verificación de las condiciones de las aulas, según lo indicado en la Descripción (visita in situ)';
        ...
        <tr>
          ...
          <td id="2">Entrevistas a la comunidad educativa sobre las condiciones de las aulas (visita in situ)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Entrevistas a la comunidad educativa sobre las condiciones de las aulas (visita in situ)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
    ...
    <div class="card-footer text-center bg-info">      
      <?php if($_SESSION['tipousuario_sisgec'] == 'Evaluador'){ ?>   
        ...
        <input type="hidden" id="rutainsert" value="aulas/calificacion/">
        <input type="hidden" id="rutaview" value="aulas/viewcalificacion/">
...
<div class="modal fade" id="exampleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="form" action="aulas/insert/">
