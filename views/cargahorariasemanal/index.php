.<div class="container container-fluid">
  ...
  <div class="card mt-3 shadow-lg p-3 mb-5 bg-body rounded">
      <ol class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item active" id="indicador" aria-current="page">Carga Horaria Semanal de los Profesores TC</li>
      </ol>
  </div>
  <!-- End Breadcrumb -->
  ...
  <div class="card">
    <div class="card-header bg-info">
      <h5 class="float-start text-light">Carga Horaria Semanal de los Profesores TC</h5>
    </div>
    <div class="card-body">
      <input id="actioneliminar" type="hidden" value="cargahorariasemanal/delete/">
      <input id="actionview" type="hidden" value="cargahorariasemanal/view/">
      ...
      <tbody>
        <tr>
          ...
          <td id="1">Contratos o nombramientos de los profesores TC y MT que permanecieron en la institución durante el periodo de evaluación (Captados a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Contratos o nombramientos de los profesores TC y MT que permanecieron en la institución durante el periodo de evaluación (Captados a través del aplicativo SIIES)';
        ...
        <tr>
          ...
          <td id="2">Matriz de horas clase de los profesores TC, en el formato entregado por el CACES. Este documento debe ser entregado en dos versiones: Excel editable y el escaneado del impreso, firmado y sellado (captada a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Matriz de horas clase de los profesores TC, en el formato entregado por el CACES. Este documento debe ser entregado en dos versiones: Excel editable y el escaneado del impreso, firmado y sellado (captada a través del aplicativo SIIES)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
    ...
    <div class="card-footer text-center bg-info">      
      <?php if($_SESSION['tipousuario_sisgec'] == 'Evaluador'){ ?>
        ...
        <input type="hidden" id="rutainsert" value="cargahorariasemanal/calificacion/">
        <input type="hidden" id="rutaview" value="cargahorariasemanal/viewcalificacion/">
...
<div class="modal fade" id="exampleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="form" action="cargahorariasemanal/insert/">
