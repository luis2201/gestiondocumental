.<div class="container container-fluid">
  ...
  <div class="card mt-3 shadow-lg p-3 mb-5 bg-body rounded">
      <ol class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item active" id="indicador" aria-current="page">Entorno Virtual de Aprendizaje</li>
      </ol>
  </div>
  <!-- End Breadcrumb -->
  ...
  <div class="card">
    <div class="card-header bg-info">
      <h5 class="float-start text-light">Entorno Virtual de Aprendizaje</h5>
    </div>
    <div class="card-body">
      <input id="actioneliminar" type="hidden" value="entornovirtual/delete/">
      <input id="actionview" type="hidden" value="entornovirtual/view/">
      ...
      <tbody>
        <tr>
          ...
          <td id="1">Entorno Virtual de Aprendizaje (EVA) (visita in situ)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Entorno Virtual de Aprendizaje (EVA) (visita in situ)';
        ...
        <tr>
          ...
          <td id="2">Evidencias de la disponibilidad 24 horas, los 7 días de la semana de los EVA; ya sea por equipos UPS (Uninterruptible Power Supply) ubicados localmente o mediante una certificación del hosting en la nube (captadas a través del aplicativo SIIES y visita in situ)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Evidencias de la disponibilidad 24 horas, los 7 días de la semana de los EVA; ya sea por equipos UPS (Uninterruptible Power Supply) ubicados localmente o mediante una certificación del hosting en la nube (captadas a través del aplicativo SIIES y visita in situ)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td id="3">Entrevistas a profesores y estudiantes sobre acceso, interfaz y utilización de EVA (visita in situ)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Entrevistas a profesores y estudiantes sobre acceso, interfaz y utilización de EVA (visita in situ)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td id="4">Estadísticas de uso del EVA (captadas a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Estadísticas de uso del EVA (captadas a través del aplicativo SIIES)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td id="5">Normativa aprobada y vigente sobre EVA (captada a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Normativa aprobada y vigente sobre EVA (captada a través del aplicativo SIIES)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td id="6">Organigrama institucional aprobado por la autoridad y manual de funciones (captados a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Organigrama institucional aprobado por la autoridad y manual de funciones (captados a través del aplicativo SIIES)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
        ...
        <tr>
          ...
          <td id="7">Guías o tutoriales de uso del EVA o, en su defecto, evidencias de las capacitaciones realizadas sobre el uso del EVA (captadas a través del aplicativo SIIES)</td>
          ...
          <td class="text-center">
            <div class="col" role="group" aria-label="Basic example">
              ...
              <?php                                     
                $evidencia = 'Guías o tutoriales de uso del EVA o, en su defecto, evidencias de las capacitaciones realizadas sobre el uso del EVA (captadas a través del aplicativo SIIES)';
                $evidencias = Model::evidencias($evidencia);
                foreach($evidencias as $row):   
              ?>                           
                <button type="button" id="<?php echo $row->iddocumento; ?>" class="btn btn-warning" onclick="view(this.id);"><i class="fa-solid fa-eye"></i></button>
    ...
    <div class="card-footer text-center bg-info">      
      <?php if($_SESSION['tipousuario_sisgec'] == 'Evaluador'){ ?>       
        ...
        <input type="hidden" id="rutainsert" value="entornovirtual/calificacion/">
        <input type="hidden" id="rutaview" value="entornovirtual/viewcalificacion/">
...
<div class="modal fade" id="exampleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="form" action="entornovirtual/insert/">
