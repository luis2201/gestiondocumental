<div class="container container-fluid">
  ...
  <div class="card mt-3 shadow-lg p-3 mb-5 bg-body rounded">
      <ol class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item active" id="indicador" aria-current="page">Programas de Estudio de las Asignaturas</li>
      </ol>
  </div>
  <!-- End Breadcrumb -->
  ...
  <div class="card">
    <div class="card-header bg-info">
      <h5 class="float-start text-light">Programas de Estudio de las Asignaturas</h5>
    </div>
    <div class="card-body">
      <input id="actioneliminar" type="hidden" value="programaestudio/delete/">
      <input id="actionview" type="hidden" value="programaestudio/view/">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td id="2">Programas de estudio de las asignaturas (PEA) (captados a través del aplicativo SIIES)</td>          
        ...
        <tr>
          ...
          <td id="3">Perfil de egreso de las carreras. (captados a través del aplicativo SIIES)</td>
          
          <td class="text-center">
            <div class="btn-group" role="group" aria-label="Basic example">
              <?php if($_SESSION['tipousuario_sisgec']=='Docencia') { 
                $evidencia = 'Perfil de egreso de las carreras. (captados a través del aplicativo SIIES)';
                $evidencias = Model::evidencias($evidencia);                
              ?>
    ...
    <div class="card-footer text-center bg-info">      
      <?php if($_SESSION['tipousuario_sisgec'] == 'Evaluador'){ ?> 
        ...
        <input type="hidden" id="rutainsert" value="programaestudio/calificacion/">
        <input type="hidden" id="rutaview" value="programaestudio/viewcalificacion/">
...
<div class="modal fade" id="exampleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="form" action="programaestudio/insert/">
